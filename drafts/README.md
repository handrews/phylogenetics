...
| `1898_whiteaves.yaml` | Whiteaves 1898 (postscript), 7(7): 395–396 | the replacement name *Steganoblastus*; check the replacement-name shape (`corrected` + synonym) against B6 |
...
| `1880_schmidt.yaml` | Schmidt 1880, Verh. Mineral. Ges. St. Petersburg (2) 15: 1–7 | the protologue of *Cyathocystis*, read from the paper itself (cf. `1879_dames.yaml`); 1879 or 1880; `type: true` resting on "der typischen Art"; *Hemicystites (subgen. Cystaster) granulatus* on p. 4 kept in notes; `rhizophora_schmidt_1889` needs this paper's year |
