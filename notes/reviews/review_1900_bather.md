...
|---|---|---|
| `metazoa-grade` | Tabular statement (p. [xii], index 13) shows "GRADE I. PROTOZOA." then a badly garbled line, OCR "MOEPAIGA", then "BRANCH A. BRANCH B. PARAZOA. ENTEROZOA." | **cannot verify** — the garbled line is the only candidate for "GRADE II. METAZOA." between Protozoa and the two branches; plausible but not legible | Owner verified on the page image (2026-09-10): the line reads "GRADE II. METAZOA." — match.
